...
from polars_profiling.model import BaseAnalysis, BaseDescription
from polars_profiling.model.alerts import get_alerts
from polars_profiling.model.correlations import (
    calculate_correlation,
    get_active_correlations,
)
from polars_profiling.model.dataframe import preprocess
from polars_profiling.model.description import TimeIndexAnalysis
from polars_profiling.model.duplicates import get_duplicates
from polars_profiling.model.missing import get_missing_active, get_missing_diagram
from polars_profiling.model.pairwise import get_scatter_plot, get_scatter_tasks
from polars_profiling.model.sample import get_custom_sample, get_sample
from polars_profiling.model.summarizer import BaseSummarizer
from polars_profiling.model.summary import get_series_descriptions
from polars_profiling.model.table import get_table_stats
from polars_profiling.model.timeseries_index import get_time_index_description
from polars_profiling.utils.progress_bar import progress
from polars_profiling.version import __version__
...
def describe(
    ...
    with tqdm(
        ...
        package = {
            "polars_profiling_version": __version__,
            "polars_profiling_config": config.json(),
        }
        pbar.update()
