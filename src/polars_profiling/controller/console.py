...
from polars_profiling.__init__ import ProfileReport, __version__
from polars_profiling.utils.dataframe import read_pandas


def parse_args(args: Optional[List[Any]] = None) -> argparse.Namespace:
    """Parse the command line arguments for the `polars_profiling` binary.
    ...
    parser.add_argument(
        "--title",
        type=str,
        default="Polars Profiling Report",
...
def main(args: Optional[List[Any]] = None) -> None:
    """Run the `polars_profiling` package.
