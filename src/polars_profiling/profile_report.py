...
from polars_profiling.config import Config, Settings
from polars_profiling.expectations_report import ExpectationsReport
from polars_profiling.model import BaseDescription
from polars_profiling.model.alerts import AlertType
from polars_profiling.model.describe import describe as describe_df
from polars_profiling.model.sample import Sample
from polars_profiling.model.summarizer import (
    BaseSummarizer,
    ProfilingSummarizer,
    format_summary,
    redact_summary,
...
from polars_profiling.report import get_report_structure
from polars_profiling.report.presentation.core import Root
from polars_profiling.report.presentation.flavours.html.templates import (
    create_html_assets,
)
from polars_profiling.serialize_report import SerializeReport
from polars_profiling.utils.dataframe import hash_dataframe
from polars_profiling.utils.varseries import VarSeries
from polars_profiling.utils.logger import ProfilingLogger
from polars_profiling.utils.paths import get_config
...
class ProfileReport(SerializeReport, ExpectationsReport):
    ...
    def _render_html(self) -> str:
        from polars_profiling.report.presentation.flavours import HTMLReport
        ...
        with tqdm(
            ...
            html = HTMLReport(copy.deepcopy(report)).render(
                ...
                version=self.description_set.package["polars_profiling_version"],
            )
    ...
    def _render_widgets(self) -> Any:
        from polars_profiling.report.presentation.flavours import WidgetReport
    ...
    def to_notebook_iframe(self) -> None:
        ...
        from polars_profiling.report.presentation.flavours.widget.notebook import (
            get_notebook_iframe,
        )
    ...
    def compare(
        ...
        Alias for:
        ```
        polars_profiling.compare([report1, report2], config=config)
        ```
        See `polars_profiling.compare` for details.
        ...
        """
        from polars_profiling.compare_reports import compare
