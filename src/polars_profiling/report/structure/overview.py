...
from polars_profiling.report.formatters import (
    fmt,
    fmt_bytesize,
    fmt_number,
    fmt_numeric,
...
from polars_profiling.report.presentation.core import Alerts, Container
from polars_profiling.report.presentation.core import Image as ImageWidget
from polars_profiling.report.presentation.core import Table
from polars_profiling.report.presentation.core.renderable import Renderable
from polars_profiling.visualisation.plot import plot_overview_timeseries
...
def get_dataset_reproduction(config: Settings, summary: BaseDescription) -> Renderable:
    ...
    version = summary.package["polars_profiling_version"]
    config_file = summary.package["polars_profiling_config"]
