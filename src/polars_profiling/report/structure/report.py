...
from polars_profiling.model.handler import get_render_map
from polars_profiling.report.presentation.core import (
    HTML,
    Collapse,
    Container,
    Dropdown,
...
from polars_profiling.report.presentation.core import Image as ImageWidget
from polars_profiling.report.presentation.core import Sample, ToggleButton, Variable
from polars_profiling.report.presentation.core.renderable import Renderable
from polars_profiling.report.presentation.core.root import Root
from polars_profiling.report.structure.correlations import get_correlation_items
from polars_profiling.report.structure.overview import get_dataset_items
from polars_profiling.utils.dataframe import slugify
...
def get_report_structure(config: Settings, summary: BaseDescription) -> Root:
    ...
    footer = HTML(
        content='Report generated by <a href="https://github.com/pytoned/polars-profiling">polars-profiling</a>.'
    )
